...
export const COSMETIC_SHOP: CosmeticItem[] = [
  { id: 'frame-amber', name: 'Moldura Âmbar', description: 'Borda dourada elegante para seu avatar.', type: 'frame', cost: 100, rarity: 'comum', previewClass: 'ring-2 ring-cine-accent/80 shadow-[0_0_20px_rgba(139,92,246,0.3)]' },
...
export const RARITY_STYLES: Record<string, { border: string; bg: string; text: string; glow: string }> = {
  ...
  lendário: { border: 'border-cine-accent/60', bg: 'bg-cine-surface/30', text: 'text-cine-cream', glow: 'shadow-[0_0_25px_rgba(139,92,246,0.25)]' },
};
