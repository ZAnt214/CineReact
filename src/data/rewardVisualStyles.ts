...
export const VISUAL_STYLES: Record<RewardVisualStyle, VisualStyleConfig> = {
  amber: {
    ...
    ring: 'ring-cine-accent-light/70 shadow-[0_0_20px_rgba(123,140,255,0.35)]',
    glow: 'shadow-[0_0_18px_rgba(123,140,255,0.25)]',
  ...
  gold: {
    ...
    glow: 'shadow-[0_0_32px_rgba(123,140,255,0.5)]',
    accent: 'text-cine-cream',
    animated: true,
    shimmer: true,
  },
