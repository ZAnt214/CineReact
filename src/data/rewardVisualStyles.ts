...
export const VISUAL_STYLES: Record<RewardVisualStyle, VisualStyleConfig> = {
  amber: {
    ...
    ring: 'ring-stone-300/70 shadow-[0_0_20px_rgba(168,162,158,0.35)]',
    glow: 'shadow-[0_0_18px_rgba(168,162,158,0.25)]',
  ...
  rainbow: {
    label: 'Arco-íris',
    gradient: 'from-rose-500 via-stone-300 via-emerald-400 via-sky-400 to-violet-500',
    gradientCss: 'linear-gradient(135deg, #f43f5e, #a8a29e, #22c55e, #38bdf8, #a855f7, #ec4899)',
  ...
  gold: {
    ...
    gradientCss: 'linear-gradient(135deg, #ca8a04, #a8a29e, #fde047)',
    ring: 'ring-stone-200/80 shadow-[0_0_36px_rgba(252,211,77,0.55)]',
    glow: 'shadow-[0_0_32px_rgba(168,162,158,0.5)]',
  ...
  ember: {
    label: 'Brasa',
    gradient: 'from-stone-600 via-red-600 to-stone-400',
    gradientCss: 'linear-gradient(135deg, #c2410c, #dc2626, #a8a29e)',
    ring: 'ring-stone-400/60 shadow-[0_0_24px_rgba(120,113,108,0.4)]',
  ...
  halloween: {
    label: 'Halloween',
    gradient: 'from-stone-900 via-zinc-950 to-purple-950',
    ring: 'ring-stone-400/70 shadow-[0_0_28px_rgba(120,113,108,0.4)]',
    glow: 'shadow-[0_0_24px_rgba(168,85,247,0.3)]',
