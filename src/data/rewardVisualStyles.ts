...
export const VISUAL_STYLES: Record<RewardVisualStyle, VisualStyleConfig> = {
  ...
  gold: {
    ...
    ring: 'ring-yellow-300/70 shadow-[0_0_30px_rgba(252,211,77,0.45)]',
    glow: 'shadow-[0_0_26px_rgba(245,158,11,0.4)]',
  ...
  midnight: {
    ...
    ring: 'ring-blue-500/40 shadow-[0_0_20px_rgba(59,130,246,0.25)]',
    glow: 'shadow-[0_0_18px_rgba(30,58,138,0.3)]',
    accent: 'text-blue-200',
  },
  cinema: {
    label: 'Cinema',
    gradient: 'from-red-950 via-zinc-950 to-black',
    ring: 'ring-red-500/50 shadow-[0_0_22px_rgba(239,68,68,0.3)]',
