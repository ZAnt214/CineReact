...
export const RARITY_STYLES: Record<RewardRarity, { border: string; bg: string; text: string; glow: string; label: string }> = {
  ...
  lendário: { border: 'border-cine-accent/60', bg: 'bg-cine-surface/30', text: 'text-cine-cream', glow: 'shadow-[0_0_25px_rgba(38,103,255,0.28)]', label: 'Lendário' },
  ...
  exclusivo: { border: 'border-cine-accent/70', bg: 'bg-cine-surface/50', text: 'text-cine-accent-light', glow: 'shadow-[0_0_35px_rgba(38,103,255,0.35)]', label: 'Exclusivo' },
};
...
const CREATOR_TAGS: RewardItemDefinition[] = [
  ...
  },
  {
    ...
    creatorColors: { from: '#3b28cc', to: '#add7f6', text: '#f0f6ff' },
  },
  {
  ...
  },
  {
    ...
    creatorColors: { from: '#2667ff', to: '#3f8efc', text: '#f0f6ff' },
  },
  {
    ...
    creatorId: 'sim-sou-lives-canal',
    creatorName: 'Sim Sou Lives',
    creatorColors: { from: '#3b28cc', to: '#87bfff', text: '#e8f2ff' },
  },
  {
...
export const CREATOR_PROGRAM_ART_ITEMS: RewardItemDefinition[] = [
  ...
  },
  {
    ...
    bundleId: CREATOR_PROGRAM_ART_BUNDLE_ID,
    limited: true,
    previewClass: 'ring-2 ring-cine-accent shadow-[0_0_28px_rgba(38,103,255,0.45)]',
    animated: true,
    visualStyle: 'atelier',
  },
  {
...
export const REWARDS_CATALOG: RewardItemDefinition[] = [
  ...
  { id: 'frame-neon', name: 'Moldura Neon', description: 'Brilho cyberpunk.', category: 'frame', rarity: 'raro', cost: 200, unlockMethod: 'shop', obtainHint: 'Loja Spotlight', previewClass: 'ring-2 ring-cine-accent/80 shadow-[0_0_25px_rgba(38,103,255,0.4)]', animated: true },
