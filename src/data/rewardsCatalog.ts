...
export const RARITY_STYLES: Record<RewardRarity, { border: string; bg: string; text: string; glow: string; label: string }> = {
  ...
  lendário: { border: 'border-cine-accent/60', bg: 'bg-cine-surface/30', text: 'text-cine-cream', glow: 'shadow-[0_0_25px_rgba(255,200,0,0.28)]', label: 'Lendário' },
  ...
  exclusivo: { border: 'border-cine-accent/70', bg: 'bg-cine-surface/50', text: 'text-cine-accent-light', glow: 'shadow-[0_0_35px_rgba(255,200,0,0.35)]', label: 'Exclusivo' },
};
...
const CREATOR_TAGS: RewardItemDefinition[] = [
  ...
  },
  {
    ...
    creatorColors: { from: '#b8860b', to: '#ffe14a', text: '#fffbeb' },
  },
  {
  ...
  },
  {
    ...
    creatorColors: { from: '#b8860b', to: '#ffc800', text: '#fffbeb' },
  },
  {
    ...
    creatorId: 'sim-sou-lives-canal',
    creatorName: 'Sim Sou Lives',
    creatorColors: { from: '#9a7209', to: '#ffe14a', text: '#fef9c3' },
  },
  {
...
export const REWARDS_CATALOG: RewardItemDefinition[] = [
  ...
  { id: 'frame-neon', name: 'Moldura Neon', description: 'Brilho cyberpunk.', category: 'frame', rarity: 'raro', cost: 200, unlockMethod: 'shop', obtainHint: 'Loja Spotlight', previewClass: 'ring-2 ring-cine-accent/80 shadow-[0_0_25px_rgba(255,200,0,0.4)]', animated: true },
