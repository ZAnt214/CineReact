...
export const RARITY_STYLES: Record<RewardRarity, { border: string; bg: string; text: string; glow: string; label: string }> = {
  ...
  lendário: { border: 'border-cine-accent/60', bg: 'bg-cine-surface/30', text: 'text-cine-cream', glow: 'shadow-[0_0_25px_rgba(123,44,191,0.28)]', label: 'Lendário' },
  ...
  exclusivo: { border: 'border-cine-accent/70', bg: 'bg-cine-surface/50', text: 'text-cine-accent-light', glow: 'shadow-[0_0_35px_rgba(123,44,191,0.35)]', label: 'Exclusivo' },
};
...
const CREATOR_TAGS: RewardItemDefinition[] = [
  ...
  },
  {
    ...
    creatorColors: { from: '#3c096c', to: '#e0aaff', text: '#f5ebff' },
  },
  {
  ...
  },
  {
    ...
    creatorColors: { from: '#7b2cbf', to: '#9d4edd', text: '#f5ebff' },
  },
  {
    ...
    creatorId: 'sim-sou-lives-canal',
    creatorName: 'Sim Sou Lives',
    creatorColors: { from: '#7b2cbf', to: '#c77dff', text: '#f5ebff' },
  },
  {
...
export const CREATOR_PROGRAM_ART_ITEMS: RewardItemDefinition[] = [
  ...
  },
  {
    ...
    bundleId: CREATOR_PROGRAM_ART_BUNDLE_ID,
    limited: true,
    previewClass: 'ring-2 ring-cine-accent shadow-[0_0_28px_rgba(123,44,191,0.45)]',
    animated: true,
    visualStyle: 'atelier',
  },
  {
...
export const REWARDS_CATALOG: RewardItemDefinition[] = [
  ...
  { id: 'frame-neon', name: 'Moldura Neon', description: 'Brilho cyberpunk.', category: 'frame', rarity: 'raro', cost: 200, unlockMethod: 'shop', obtainHint: 'Loja Spotlight', previewClass: 'ring-2 ring-cine-accent/80 shadow-[0_0_25px_rgba(123,44,191,0.4)]', animated: true },
