...
export const RARITY_STYLES: Record<RewardRarity, { border: string; bg: string; text: string; glow: string; label: string }> = {
  ...
  lendário: { border: 'border-cine-accent/60', bg: 'bg-cine-surface/30', text: 'text-cine-cream', glow: 'shadow-[0_0_25px_rgba(56, 189, 248,0.28)]', label: 'Lendário' },
  ...
  exclusivo: { border: 'border-cine-accent/70', bg: 'bg-cine-surface/50', text: 'text-cine-accent-light', glow: 'shadow-[0_0_35px_rgba(56, 189, 248,0.35)]', label: 'Exclusivo' },
};
...
const CREATOR_TAGS: RewardItemDefinition[] = [
  ...
  },
  {
    ...
    creatorColors: { from: '#0ea5e9', to: '#7dd3fc', text: '#f0f9ff' },
  },
  {
  ...
  },
  {
    ...
    creatorColors: { from: '#38bdf8', to: '#38bdf8', text: '#f0f9ff' },
  },
  {
    ...
    creatorId: 'sim-sou-lives-canal',
    creatorName: 'Sim Sou Lives',
    creatorColors: { from: '#38bdf8', to: '#d4d4d8', text: '#f0f9ff' },
  },
  {
...
export const CREATOR_PROGRAM_ART_ITEMS: RewardItemDefinition[] = [
  {
    ...
    limited: true,
    previewGradient: 'from-cine-accent-dark via-cine-accent to-cine-accent-light',
    animated: true,
    visualStyle: 'atelier',
  },
  {
    ...
    bundleId: CREATOR_PROGRAM_ART_BUNDLE_ID,
    limited: true,
    previewClass: 'ring-2 ring-cine-accent shadow-[0_0_28px_rgba(56, 189, 248,0.45)]',
    animated: true,
    visualStyle: 'atelier',
  },
  {
...
export const REWARDS_CATALOG: RewardItemDefinition[] = [
  ...
  { id: 'frame-neon', name: 'Moldura Neon', description: 'Brilho cyberpunk.', category: 'frame', rarity: 'raro', cost: 200, unlockMethod: 'shop', obtainHint: 'Loja Spotlight', previewClass: 'ring-2 ring-cine-accent/80 shadow-[0_0_25px_rgba(56, 189, 248,0.4)]', animated: true },
