        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          {!isDrawing && countdown === null && (
            <button
              ...
              disabled={!hasVideos}
              className="shrink-0 inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-gradient-to-r from-cine-accent-light to-cine-accent hover:from-cine-cream hover:to-cine-accent-light text-black font-black text-sm transition-all shadow-lg shadow-cine-accent/20 disabled:opacity-40 cursor-pointer active:scale-[0.98]"
            >
