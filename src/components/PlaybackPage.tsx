...
export default function PlaybackPage({ 
  ...
  const getAvatarColor = (name: string) => {
    const colors = [
      'from-cine-accent-light to-cine-accent-dark shadow-[0_0_12px_rgba(212,132,92,0.2)]',
      'from-cine-accent to-cine-accent-dark shadow-[0_0_12px_rgba(212,132,92,0.2)]',
    ];
    let sum = 0;
  ...
  return (
    <motion.div 
      ...
      className="cine-container pt-24 pb-20 min-h-screen bg-[#0c1014] w-full"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
        ...
        <div className={`${isTheaterMode ? 'lg:col-span-12' : 'lg:col-span-8 xl:col-span-9'} space-y-6 transition-all duration-300`}>
          ...
          <div className="relative group/player rounded-3xl p-[2px] bg-gradient-to-tr from-cine-accent-light/60 via-cine-accent-light/80 to-cine-accent-dark/60 hover:from-cine-cream hover:via-cine-cream hover:to-cine-accent shadow-[0_20px_50px_rgba(0,0,0,0.9),0_0_40px_rgba(212,132,92,0.25)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.95),0_0_65px_rgba(212,132,92,0.45)] transition-all duration-500">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-col items-center gap-4 text-center px-4">
                      <div className="relative flex items-center justify-center">
                        ...
                        <div className="w-16 h-16 rounded-full border-2 border-cine-accent/20 border-t-cine-accent-light border-r-cine-accent-light animate-spin shadow-[0_0_20px_rgba(212,132,92,0.3)]" />
