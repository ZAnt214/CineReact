        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-zinc-500 mt-1">
              ...
              <span className="text-cine-accent-light font-bold">{spotlight} Spotlight</span>
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <button
              ...
              disabled={redeeming}
              className="px-3 py-2 rounded-xl bg-cine-accent/20 text-cine-accent-light border border-cine-accent/30 text-xs font-bold cursor-pointer"
            >
              Resgatar
            </button>
          </div>
          ...
          >
            ...
            >
              <div className="flex items-start justify-between gap-3 mb-4">
                <div>
                  <p className="text-[10px] font-mono uppercase tracking-widest text-cine-accent/80 mb-1">
