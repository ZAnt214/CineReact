...
export default function LandingPage({ onExplore, isNavigating = false }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#141210] text-white font-sans selection:bg-stone-400/30 selection:text-stone-100 relative overflow-x-hidden flex flex-col justify-between">
      {/* Background Decorative Gradients & Grid Glow (No media thumbnails or posters) */}
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-gradient-to-b from-stone-400/15 via-stone-400/5 to-transparent rounded-full blur-3xl opacity-70" />
        <div className="absolute top-1/3 -left-40 w-96 h-96 bg-stone-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-10 -right-40 w-96 h-96 bg-stone-400/10 rounded-full blur-3xl" />
        <div className="absolute inset-0 bg-[radial-gradient(#1f1f23_1px,transparent_1px)] [background-size:24px_24px] opacity-20" />
      </div>

      {/* HEADER / BRAND BAR */}
      <header className="relative z-10 border-b border-stone-800/80 bg-[#141210]/95 max-md:backdrop-blur-none md:bg-[#141210]/80 md:backdrop-blur-md sticky top-0">
        <div className="cine-container w-full h-20 flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-stone-300 to-stone-400 text-black font-extrabold text-xs sm:text-sm hover:from-stone-200 hover:to-stone-300 transition-all shadow-md shadow-stone-400/20 hover:shadow-stone-400/40 cursor-pointer active:scale-95 shrink-0 disabled:opacity-80 disabled:cursor-wait"
          >
      ...
      <section className="relative z-10 cine-container w-full pt-12 pb-16 sm:pt-20 sm:pb-24 text-center">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-stone-400/10 border border-stone-400/30 text-stone-300 text-xs font-semibold mb-6 shadow-inner"
        >
          <Sparkles className="w-3.5 h-3.5 text-stone-300 animate-pulse" />
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-stone-200 via-stone-300 to-stone-400">
        ...
        >
          <button
            onClick={onExplore}
            disabled={isNavigating}
            className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-stone-300 via-stone-300 to-stone-400 text-black font-black text-base sm:text-lg hover:brightness-110 transition-all transform hover:-translate-y-0.5 active:translate-y-0 shadow-xl shadow-stone-400/25 hover:shadow-stone-400/40 flex items-center justify-center gap-3 cursor-pointer disabled:opacity-80 disabled:cursor-wait disabled:transform-none"
          >
      ...
      <section className="relative z-10 cine-container w-full py-16 border-t border-zinc-900/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Benefit 1 */}
          <div className="p-6 rounded-2xl bg-zinc-950 border border-zinc-800/80 hover:border-stone-400/40 transition-all group flex flex-col justify-between">
            <div>
              <div className="w-12 h-12 rounded-xl bg-stone-400/10 border border-stone-400/20 flex items-center justify-center text-stone-300 mb-5 group-hover:scale-110 transition-transform">
      ...
      <section className="relative z-10 cine-container w-full py-16 border-t border-zinc-900/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/60 relative">
            <span className="text-4xl font-black text-stone-400/30 mb-3 block">01</span>
          ...
          {/* Step 2 */}
          <div className="p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/60 relative">
            <span className="text-4xl font-black text-stone-400/30 mb-3 block">02</span>
          ...
          {/* Step 3 */}
          <div className="p-6 rounded-2xl bg-zinc-950/80 border border-zinc-800/60 relative">
            <span className="text-4xl font-black text-stone-400/30 mb-3 block">03</span>
      ...
      <section className="relative z-10 cine-container w-full py-12 my-8">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-zinc-900 via-zinc-950 to-zinc-900 border border-stone-400/30 text-center relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-64 h-64 bg-stone-400/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="mt-8 relative z-10">
            <button
              onClick={onExplore}
              disabled={isNavigating}
              className="px-8 py-4 rounded-2xl bg-gradient-to-r from-stone-300 to-stone-300 text-black font-black text-base hover:brightness-110 transition-all shadow-xl shadow-stone-400/20 cursor-pointer inline-flex items-center gap-3 disabled:opacity-80 disabled:cursor-wait"
            >
              <span>{isNavigating ? 'Abrindo catálogo...' : 'Explorar o CineReact'}</span>
              {isNavigating ? (
                <Loader2 className="w-5 h-5 animate-spin" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 space-y-2 my-4">
                    ...
                    <a 
                      ...
                      className="text-stone-300 hover:text-stone-200 font-bold text-sm sm:text-base underline flex items-center gap-2"
                    >
