    ...
    <div className="pt-24 pb-20 px-4 md:px-8 max-w-5xl mx-auto min-h-screen text-zinc-300">
      ...
      >
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/10 border border-rose-500/25 text-rose-400 text-[10px] font-bold tracking-wider uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-2">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl p-5 relative overflow-hidden flex flex-col justify-between">
            <div className="absolute top-0 right-0 w-20 h-20 bg-teal-500/5 blur-2xl rounded-full" />
            <div>
              <div className="w-10 h-10 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-400 mb-4 border border-teal-500/20">
                <Sparkles className="w-5 h-5" />
              </div>
              <h3 className="text-sm font-bold text-white mb-2 uppercase tracking-wide">Nome Personalizado</h3>
              <p className="text-xs text-zinc-500 leading-relaxed">
                Seu nome de usuário receberá uma estilização única com gradiente brilhante (<span className="text-teal-400 font-bold">Teal</span> para <span className="text-rose-400 font-bold">Rosa</span>) em todos os comentários, chat ao vivo e painéis.
              </p>
            </div>
            <div className="text-[10px] text-teal-400/80 font-mono mt-4 flex items-center gap-1.5">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl p-5 relative overflow-hidden flex flex-col justify-between">
            ...
            <div>
              <div className="w-10 h-10 rounded-xl bg-rose-500/10 flex items-center justify-center text-rose-400 mb-4 border border-rose-500/20">
                <Gift className="w-5 h-5" />
              </div>
              <h3 className="text-sm font-bold text-white mb-2 uppercase tracking-wide">Tag Exclusiva</h3>
              <p className="text-xs text-zinc-500 leading-relaxed">
                Exiba orgulhosamente a tag <span className="px-1.5 py-0.5 rounded bg-gradient-to-r from-rose-500 to-teal-600 text-[9px] uppercase font-bold text-white tracking-wider">APOIADOR VIP</span> ao lado do seu nome, diferenciando você nas avaliações e chats.
              </p>
            </div>
            <div className="text-[10px] text-rose-400/80 font-mono mt-4 flex items-center gap-1.5">
        ...
        <div className="max-w-2xl mx-auto pt-4">
          <div className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl p-6 md:p-8 space-y-6 text-center flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-teal-500/10 flex items-center justify-center text-teal-400 border border-teal-500/20 mb-1">
            ...
            {/* Instruction Advice */}
            <div className="flex gap-3 bg-teal-950/20 border border-teal-500/20 rounded-xl p-4 text-xs text-teal-300 max-w-lg text-left">
              <Gift className="w-5 h-5 text-teal-400 flex-shrink-0 mt-0.5 animate-bounce" />
