...
export function buildCreatorPartnersMailto() {
  ...
  return `mailto:${CREATOR_PARTNERS_EMAIL}?subject=${emailSubject}&body=${emailBody}`;
}

interface CreatorPartnersContentProps {
  onClose?: () => void;
  showCloseActions?: boolean;
}

export default function CreatorPartnersContent({ onClose, showCloseActions = true }: CreatorPartnersContentProps) {
  const mailtoHref = buildCreatorPartnersMailto();
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="lg:col-span-2 flex flex-col justify-between p-6 sm:p-8 pt-8 sm:pt-10 lg:pt-8 bg-gradient-to-br from-neutral-900 via-neutral-950 to-black border-b lg:border-b-0 lg:border-r border-neutral-800/80 relative overflow-hidden"
      >
        <motion.div
      ...
      >
        ...
        <header>
          ...
          >
            Evolua seu canal no{' '}
            <span className="text-cine-accent">CineReact</span>
          </h1>
        ...
        <footer className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 pt-4 border-t border-neutral-800/80">
          <div className="flex items-center gap-2.5 text-xs text-zinc-500">
            ...
            <span>
              Fale conosco:{' '}
              <strong className="text-cine-cream font-mono font-bold">{CREATOR_PARTNERS_EMAIL}</strong>
            </span>
          </div>
