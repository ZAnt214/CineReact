        ...
        <AnimatePresence>
          {centerAnimation && (
            <motion.div
              ...
              className="absolute pointer-events-none z-30 w-20 h-20 rounded-full bg-cine-accent/90 backdrop-blur-md flex flex-col items-center justify-center text-black shadow-[0_0_40px_rgba(233,168,130,0.9)] border border-cine-cream/40"
            >
          ...
          <div className={`absolute bottom-0 left-0 right-0 z-20 p-3 sm:p-5 bg-gradient-to-t from-black/95 via-black/80 to-transparent space-y-3 transition-all duration-300 ${
            ...
            <div className="relative group/timeline py-2 cursor-pointer">
              ...
              >
                ...
                <div 
                  className="h-full bg-gradient-to-r from-cine-accent-light via-cine-accent-light to-cine-cream rounded-full shadow-[0_0_15px_rgba(233,168,130,0.9)] relative"
                  style={{ width: `${duration ? (currentTime / duration) * 100 : 0}%` }}
                >
                  <div className="absolute right-0 top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-white rounded-full shadow-[0_0_10px_rgba(233,168,130,1)] scale-0 group-hover/timeline:scale-100 transition-transform" />
                </div>
              </div>
