        ...
        {activePlatforms.map(({ key }) => {
          ...
          return (
            <a
              ...
              className={`group relative flex w-full min-w-0 items-center overflow-hidden rounded-lg border border-cine-accent/10 bg-cine-surface/80 backdrop-blur-sm transition-all hover:border-cine-accent/30 hover:bg-cine-elevated/80 hover:shadow-[0_0_18px_rgba(255,184,0,0.12)] ${cfg.strip}`}
            >
              <span
