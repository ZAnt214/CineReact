        ...
        {activePlatforms.map(({ key }) => {
          ...
          return (
            <a
              ...
              className={`group relative flex w-full min-w-0 items-center overflow-hidden rounded-lg border border-cine-accent/10 bg-neutral-950/75 backdrop-blur-sm transition-all hover:border-cine-accent/30 hover:bg-neutral-900/80 hover:shadow-[0_0_18px_rgba(38,103,255,0.1)] ${cfg.strip}`}
            >
              <span
