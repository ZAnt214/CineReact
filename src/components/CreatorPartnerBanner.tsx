  ...
  return (
    <AnimatePresence>
      <motion.aside
        ...
        className="creator-partner-banner fixed right-3 left-3 z-[100] mx-auto w-auto max-w-4xl overflow-hidden rounded-2xl border border-cine-accent/35 bg-cine-bg/95 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.7),0_0_40px_rgba(201,162,39,0.12)]"
