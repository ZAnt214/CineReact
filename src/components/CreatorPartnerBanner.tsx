...
export default function CreatorPartnerBanner({ onClick, onClose }: CreatorPartnerBannerProps) {
  ...
  return createPortal(
    <AnimatePresence>
      <div
        className="fixed inset-x-0 z-[120] pointer-events-none px-3"
      ...
      >
        <motion.aside
          ...
          className="creator-partner-banner pointer-events-auto mx-auto w-full max-w-4xl overflow-hidden rounded-2xl border border-cine-accent/35 bg-cine-bg/95 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.7),0_0_40px_rgba(0,212,255,0.12)]"
        ...
        >
          ...
          <div className="relative flex items-center gap-2.5 p-2.5 sm:gap-4 sm:p-3.5">
            <button
              type="button"
              onClick={onClick}
