...
export default function PlaybackSkeleton() {
  ...
  return (
    <div className="cine-container pt-24 pb-20 min-h-screen bg-[#0f0f0f] w-full animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-8 xl:col-span-9 space-y-6">
          ...
          <div className="relative w-full bg-neutral-900/60 rounded-2xl aspect-video border border-neutral-800/40 shadow-2xl flex items-center justify-center">
            {/* Subtle inner center logo/ring accent */}
            <div className="w-16 h-16 rounded-full border-4 border-neutral-800/40 border-t-zinc-700/60 animate-spin" />
          </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="space-y-2">
              <div className="h-7 bg-neutral-800 rounded-lg w-10/12" />
              <div className="h-7 bg-neutral-800 rounded-lg w-6/12" />
            </div>
          </div>

          {/* Actions & Creator Row */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-4 border-b border-neutral-900 pb-5">
            {/* Creator Circle + Info */}
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="w-24 h-9 bg-neutral-800 rounded-xl" />
              <div className="w-10 h-9 bg-neutral-800 rounded-xl" />
            </div>
          </div>

          {/* Description Block */}
          <div className="bg-neutral-900/20 p-4 rounded-xl border border-neutral-800/60 space-y-2.5">
          ...
          <div className="space-y-4 pt-6 border-t border-neutral-900">
            ...
            <div className="flex gap-4 overflow-x-hidden pb-4 pt-1">
              {carouselItems.map((_, idx) => (
                <div key={idx} className="flex-shrink-0 w-[240px] md:w-[290px] bg-neutral-900/15 border border-neutral-800/60 rounded-xl overflow-hidden flex flex-col">
                  {/* Thumbnail */}
                  ...
                  <div className="p-3.5 space-y-2.5 flex-1">
                    ...
                    <div className="pt-2 flex justify-between">
                      ...
                      <div className="h-2.5 bg-neutral-800/40 rounded w-1/4" />
                    </div>
                  </div>
                </div>
              ))}
        ...
        <div className="lg:col-span-4 xl:col-span-3 space-y-5">
          ...
          <div className="border-b border-neutral-900 pb-3">
            ...
            <div className="h-3 bg-neutral-800 rounded w-44 mt-2" />
          </div>
          ...
          <div className="flex flex-col gap-3.5">
            {sidebarItems.map((_, idx) => (
              <div key={idx} className="flex gap-3.5 p-2 rounded-xl">
                {/* Thumbnail Frame */}
                <div className="relative w-28 h-18 sm:w-36 sm:h-22 flex-shrink-0 bg-neutral-900 rounded-lg overflow-hidden border border-neutral-800/40" />
