...
export const DEFAULT_PLATFORM_SETTINGS: PlatformSettings = {
  ...
  seoTitle: 'CineReact — Descubra reacts do YouTube',
  seoDescription: 'A principal plataforma para descobrir, organizar e acompanhar reacts do YouTube.',
  seoKeywords: 'react, youtube, filmes, séries, animes',
  socialYoutube: '',
  socialInstagram: '',
  socialTwitter: '',
  socialDiscord: '',
